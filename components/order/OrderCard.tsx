...
export default function OrderCard({ order }: OrderCardProps ) {
    ...
    return (
        <section
            ...
            className="mt-16 rounded-lg bg-gray-50 px-4 py-6 sm:p-6  lg:mt-0 lg:p-8 space-y-4 text-center"
        >
            ...
            <dl className="mt-6 space-y-4">
                {order.orderProducts.map(product =>(
                    <div key={product.productId }
                     ...
                     >
                        <dt className=" flex items-center font-black text-sm text-gray-600">
                ...
                <div className="flex items-center justify-between border-t border-gray-200 pt-4">
                    <dt className="text-base font-medium text-gray-900 shadow-lg">Total a Pagar:</dt>
                    <dd className="text-xl  text-gray-900 font-bold bg-blue-200">{formaCurrency(order.total)}</dd>
                </div>
            </dl>
